            ...
            <span class="login">
                ...
                <span>
                    ...
                    <div class="input-group mb-2">
                        ...
                        <input name="confirm" type="password" class="form-control" id="inlineFormInputGroup" placeholder="Confirm Password">
                    </div>
                </span>
                <button type="submit" class="btn btn-outline-dark mb-2">Sign Up</button><br>
